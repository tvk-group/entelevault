...
| Cryptography design | deprecated primitive, unsafe parameter, weak randomness, nonce reuse, lifecycle gap, side channel, incompatible implementation, or unsafe migration | inventory, approved primitives/parameters, KDF/randomness/nonce policy, lifecycle/agility/provenance review, vectors, rollback, independent cryptography assessment | exhaustive VaultLab cryptography gate + expert design review |
| Security disclosure | ambiguous bounty scope, missing safe harbor, researcher privacy breach, overdue triage, unmanaged duplicate, reward dispute, or premature publication | published policy, exact scope, safe harbor, protected channels/privacy, triage/severity, rewards, legal/emergency paths, evidence/remediation tracking, publication approval | exhaustive VaultLab disclosure gate + separately operated program |
| Third-party risk | unknown critical dependency, weak due diligence, excessive access, hidden subprocessor, late incident notice, concentration, failed continuity, or no exit | inventory/criticality, security/privacy review, data/access mapping, contract/subprocessor controls, notification, continuity, concentration, exit, monitoring | exhaustive VaultLab third-party gate + procurement/legal review |
