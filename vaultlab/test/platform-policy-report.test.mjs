...
test("the complete twelve-gate platform report validates", () => {
  const validated = validatePlatformPolicyReport(report());
  assert.equal(validated.result, "PASS");
  assert.equal(validated.summary.total, 12);
